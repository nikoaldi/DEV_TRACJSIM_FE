...
const ADSBHome = (props) => {
    ...
    const getCountry= async () => {
        try{
        const response = await Axios.get('http://localhost:8080/radar/enum');
                ...
                <div className="data-setting">
                    <table className="table-input"  >
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>id:{id}, radio:{statusRadio}, status:{edit}, COUNTRY : {country}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>Country</td>
                            <td>             
                                <select id="country" class="form-input" onChange={(e) => setCountry(e.target.value)} disabled>
