...
const RadarHome = (props) => {
    ...
    const [courseRangeMin, setCourseRangeMin] = useState(null);
    const [courseRangeMax, setCourseRangeMax] = useState(null);
    const [courseIncrement, setCourseIncrement] = useState(null);
    ...
    // REQUEST POST SAVE SINGLE RADAR TRACK
    ...
    const handleTrackMode=(event)=>{
        ...
        disableFormInput(trackInput, Tmode, edit, statusRadio)
    }
    ...
    const disableFormInput=(Tinput, Tmode, getEdit, radio, edit1)=>{  
    ...
    const handleGetUpdateRadarTrack = async (e) => {
        ...
        disableFormInput(item.trackInput, item.trackMode, getEdit, item.radio, "edit")
    }
    ...
    <div className="main-container">   
        ...
        <label className="label">DATA SETTING</label>
            ...
            <Button variant="btn btn-primary mt-2" onClick={handlerValidasiInputSaveAndSendUpdate}>
                SAVE & SEND
            </Button>
