...
const AISHome = (props) => {
    ...
    const [aisType, setAisType] = useState("NS");
    const [shipCallSign, setShipCallSign] = useState("");
    const [imoNumber, setImoNumber] = useState("");
    const [eta, setEta] = useState("");
    const [navStatus, setNavStatus] = useState(15);
    ...
    const enumAisType = [
        {enum: 'NO_STATEMENT',    text: 'NS'},
        {enum: 'RESERVED_1',    text: 'Reserved 1'},
        {enum: 'WING_IN_GROUND',    text: 'Wing In Ground'},
        {enum: 'SAR_AIRCRAFT',    text: 'SAR Air Craft'},
        {enum: 'FISHING',    text: 'Fishing'},
        {enum: 'TOWING',    text: 'Towing Vessel'},
        {enum: 'LARGE_TOWING',    text: 'Large Towing Vessel'},
        {enum: 'DREDGER',    text: 'Dredger'},
        {enum: 'DIVE_VESSEL',    text: 'Dive Vessel'},
        {enum: 'MILITARY_OPS',    text: 'Military Ops'},
        {enum: 'SAILING_VESSEL',    text: 'Sailing Vessel'},
        {enum: 'PLEASURE_CRAFT',    text: 'Pleasure Craft'},
        {enum: 'RESERVED_2',    text: 'Reserved 2'},
        {enum: 'HIGH_SPEED_CRAFT',    text: 'High Speed Craft'},
        {enum: 'PILOT_VESSEL',    text: 'Pilot Vessel'},
        {enum: 'SAR',    text: 'SAR Vessel'},
        {enum: 'TUG',    text: 'Tug'},
        {enum: 'PORT_TENDER',    text: 'Port Tender'},
        {enum: 'ANTI_POLLUTION',    text: 'Anti Pollution'},
        {enum: 'LAW_ENFORCEMENT',    text: 'Law Enforcement'},
        {enum: 'LOCAL_VESSEL_1',    text: 'Local Vessel 1'},
        {enum: 'LOCAL_VESSEL_2',    text: 'Local Vessel 2'},
        {enum: 'MEDICAL_TRANSPORT',    text: 'Medical Transport'},
        {enum: 'SPECIAL_CRAFT',    text: 'Special Craft'},
        {enum: 'PASSENGER',    text: 'Passenger'},
        {enum: 'CARGO',    text: 'Cargo'},
        {enum: 'CARGO_HAZARDOUS_A',    text: 'Cargo Hazardous A'},
        {enum: 'CARGO_HAZARDOUS_B',    text: 'Cargo Hazardous B'},
        {enum: 'CARGO_HAZARDOUS_C',    text: 'Cargo Hazardous C'},
        {enum: 'CARGO_HAZARDOUS_D',    text: 'Cargo Hazardous D'},
        {enum: 'CARGO',    text: 'Cargo'},
        {enum: 'TANKER',    text: 'Tanker'},
        {enum: 'TANKER_HAZARDOUS_A',    text: 'Tanker Hazardous A'},
        {enum: 'TANKER_HAZARDOUS_B',    text: 'Tanker Hazardous B'},
        {enum: 'TANKER_HAZARDOUS_C',    text: 'Tanker Hazardous C'},
        {enum: 'TANKER_HAZARDOUS_D',    text: 'Tanker Hazardous D'},
        {enum: 'TANKER',    text: 'Tanker'},
        {enum: 'OTHER',    text: 'Other'}
    ];
    ...
    const handlerCancel=(event)=>{
        ...
        document.getElementById("tmr").disabled = true;
        const $selectaisType = document.getElementById('ais-type');
        $selectaisType.value = "NS";
        const $selectNavStatus = document.getElementById('nav-status');
        $selectNavStatus.value = "NS";
        const $selectTrackInput = document.getElementById('ti');
                    ...
                    <table className="table-input">
                        <tr>
                         ...
                         <tr>
                            ...
                            <td></td>
                            <td colSpan={3}>id:{id}, radio:{statusRadio}, status:{edit}, AType:{aisType}, NStatus : {navStatus}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>             
                                <select name="ais-type" class="form-input" id="ais-type"  onChange={(e) => setAisType(e.target.value)} disabled>
                                    {enumAisType.map(item => {
                                        return (<option key={item.enum} value={item.text}>{item.text}</option>);
                                    })}
                                </select>
                            </td>
                            <td>Nav Status</td>
                            <td>             
                                <select name="nav-status" class="form-input" id="nav-status" onChange={(e) => setNavStatus(e.target.value)} disabled>
                                    <option value="15">No Statement</option>
                                    <option value="0">Under Way Using Engine</option>
                                    <option value="1">At Anchor</option>
                                    <option value="2">Not Under Command</option>
                                    <option value="3">Restricted Manoeuvrability</option>
                                    <option value="4">Constraint By Her Draught</option>
                                    ...
                                    <option value="9">Reserved for future use 9</option>
                                    <option value="10">Reserved for future use 10</option>
                                    <option value="11">Power Driven Vessel Towing Astern</option>
                                    <option value="12">Power Driven Vessel Pushing Ahead Or Towing Alongside</option>
                                    <option value="13">Reserved For Future Use 13</option>
                                    <option value="14">Sart Mob Or Epirb</option>
