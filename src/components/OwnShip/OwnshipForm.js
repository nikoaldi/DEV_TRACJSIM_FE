...
const OwnshipForm = (props) => {
    ...
    // REQUEST POST SAVE OWNSHIP TRACK --
    ...
    // REQUEST POST SAVE AND SEND OWNSHIP TRACK --
    ...
    // Function Request PUT Update Data OwnShip Track --
    ...
    // HANDLER SEND STOP OWNSHIP TRACK --
                ...
                <div className="data-setting" >
                    <table className="table-input">
                            ...
                            <tr>
                                ...
                                <td>Track Mode : {trackMode}, status: {status}</td>
